    ...
    <div className="auth-container">
      <div className="auth-split reverse">
        <div className="auth-welcome-section">
          ...
          <p className="welcome-subtitle">Register with your school details to get started</p>
          <button className="auth-switch-btn" onClick={switchToLogin}>Sign In</button>
        </div>
        <div className="auth-form-section">
          <h2 className="auth-title">Create Account</h2>
          <div style={{ background: 'rgba(34,197,94,0.08)', padding: '12px 16px', borderRadius: '10px', marginBottom: '20px', border: '1px solid rgba(34,197,94,0.3)' }}>
          ...
          <form onSubmit={handleSubmit}>
            <select className="auth-input" value={formData.role} onChange={set('role')} disabled={loading} required style={selectStyle}>
            ...
            <select className="auth-input" value={formData.gender} onChange={set('gender')} disabled={loading} style={selectStyle}>
